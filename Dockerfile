...
LABEL org.ioccc.image.version="0.4.5 2024-10-24"
...
RUN chmod 0555 ioccc.py ioccc_common.py iocccpasswd.py
RUN chown root:root ioccc.py ioccc_common.py iocccpasswd.py
